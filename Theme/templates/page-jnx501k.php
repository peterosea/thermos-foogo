...
<main class="pageTemplate tkfe350">
  ...
  <div class="section section1 mb-5">
    <div class="container">
      ...
      <img draggable="false" src="<?php echo $zeplin ?>/3028.png" srcset="<?php echo $zeplin ?>/3028@2x.png 2x, <?php echo $zeplin ?>/3028@3x.png 3x">
    </div>
  </div>
  <?php
  ...
  <div class="section section5">
    <div class="container">
      <div class="header">
        ...
        <p>
          가볍고 슬림한 디자인으로 가방 속 아기용품 부피를 줄여주고,<br />
          지구의 자연을 연상시키는 얼씨톤의 컬러를 포인트로 사용하여<br />
      ...
      <div class="row light-blue-grey">
        ...
        <div class="col-6 contentCol">
          ...
          <p>
            WHO(세계보건기구) 및 식품의약품안전처는 분유 타는 물의 온도를 <br />
            70도 이상으로 권고하고 있어요. JNX는 분유 조제를 위해<br />
            5시간 기준 70도 이상으로 적당한 온도를 유지해줘요.
          </p>
        </div>
      </div>
      <div class="row three pb-0">
        <div class="col-6 imgCol">
        ...
        <div class="col-6 contentCol">
          ...
          <p>
            아기가 커서 더는 분유를 먹지 않으면 엄마와 아빠를 위한 <br />
            휴대용 텀블러로 사용할 수 있어요.
          </p>
        </div>
      </div>
  ...
  <div class="section section6">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-5">
          <img draggable="false" src="<?php echo $zeplin ?>/3019.png" srcset="<?php echo $zeplin ?>/3019@2x.png 2x, <?php echo $zeplin ?>/3019@3x.png 3x">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-5">
          <img draggable="false" src="<?php echo $zeplin ?>/3022.png" srcset="<?php echo $zeplin ?>/3022@2x.png 2x, <?php echo $zeplin ?>/3022@3x.png 3x">
        </div>
      </div>
