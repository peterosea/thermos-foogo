  ...
  <div class="section why">
    <div class="container">
      <h1 class="d-none d-md-block">
        아이의 텀블러는 왜<br />
        <span class="pointBg">진공단열 스테인리스 텀블러</span>이어야 할까?
      </h1>
      ...
      <div class="mainImgWrap d-block d-md-none">
        <img draggable="false" src="$zeplin/tkff280-sec03-01.png" srcset="$zeplin/tkff280-sec03-01@2x.png 2x, $zeplin/tkff280-sec03-01@3x.png 3x">
      </div>
      <div class="body">
