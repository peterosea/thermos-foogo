<div class="section section5">
  ...
  <div class="slide">
    <div class="container">
      <div class="row gx-md-5 mb-5 mb-md-0">
      ...
      <div class="row">
        <div class="col-12 d-flex justify-content-center position-relative">
          ...
          <img class="main" draggable="false" src="<?php echo $zeplin ?>/2932.png" srcset="<?php echo $zeplin ?>/2932@2x.png 2x, <?php echo $zeplin ?>/2932@3x.png 3x">
        </div>
      </div>
    </div>
  </div>
