  ...
  <div class="slide">
    <div class="container">
      <div class="row gx-md-5 mb-5 mb-md-0 contentRow">
        ...
        <div class="col-12 col-md-6 px-4 px-md-5">
          <p>
            토출량 조절판이 있어 소,중,대 3단계로<br />
            <span class="pointBg">음료가 나오는 양을 조절할 수 있어요.</span>
          </p>
        </div>
      </div>
      <div class="row">
      ...
      <div class="row gx-md-5 mb-5 mb-md-0 contentRow">
        ...
        <div class="col-12 col-md-6 px-4 px-md-5">
          <p>
            ...
            5시간 기준 70이상 보온 효력은 물론<br />
            분유 제조용 사용이 끝나면 어른용 텀블러로 사용하세요.
          </p>
        </div>
      </div>
      <div class="row">
