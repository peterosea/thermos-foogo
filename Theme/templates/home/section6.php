    ...
    <div class="row">
      <div class="col-12 px-4 px-md-3">
        <div class="header">
          ...
          <p class="d-none d-md-block">푸고 공식 인스타그램에 매일 업데이트되는 새로운 이야기를 만나보세요</p>
        </div>
        <div class="body">
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 d-flex align-items-center justify-content-center">
        <a href="">
          <img src="<?php echo $zeplin ?>/2933.png" srcset="<?php echo $zeplin ?>/2933@2x.png 2x, <?php echo $zeplin ?>/2933@3x.png 3x">
